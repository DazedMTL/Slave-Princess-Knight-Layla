...
Scene_Boot.prototype.start = function () {
  ...
  if (DataManager.isBattleTest()) {
    ...
    SceneManager.goto(Nore.Scene_Battle2);
...
Scene_Boot.prototype.updateDocumentTitle = function () {
  if (Nore.isFreeTaikenban()) {
    document.title = "奴隷姫騎士レイラ　体験版  ver " + VERSION;
  } else if (Nore.isTaikenban()) {
    document.title = "次回作　先行有料体験版";
  } else {
    document.title = $dataSystem.gameTitle + "  ver " + VERSION;
  }
};
...
// Scene_Message
//
// The superclass of Scene_Map and Nore.Scene_Battle2.
...
Scene_Map.prototype.update = function () {
  ...
  if (this.isSceneChangeOk()) {
    this.updateScene();
  } else if (SceneManager.isNextScene(Nore.Scene_Battle2)) {
...
Scene_Map.prototype.needsFadeIn = function () {
  return (
    SceneManager.isPreviousScene(Nore.Scene_Battle2) ||
