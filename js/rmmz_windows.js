...
Window_StatusBase.prototype.placeStateIcon = function (actor, x, y) {
  ...
  const sprite = this.createInnerSprite(key, Nore.Sprite_StateIcon2);
  sprite.setup(actor);
  sprite.move(x, y);
  sprite.show();
};
...
Window_BattleLog.prototype.performDamage = function (target, shieldDamage) {
