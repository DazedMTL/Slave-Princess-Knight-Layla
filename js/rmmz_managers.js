...
DataManager.createGameObjects = function () {
  $gameTemp = new Game_Temp2();
  $gameSystem = new Game_System2();
  ...
  $gameParty = new Game_NoreParty();
  $gameTroop = new Game_Troop2();
  $gameMap = new Game_Map();
  $gamePlayer = new Game_Player2();
